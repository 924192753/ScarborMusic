...
echo "  mkdir -p /opt/scarbormusic && tar -xzf ${ARCHIVE_NAME} -C /opt/scarbormusic"
echo "  cp .env.production.ip.example .env.production && vim .env.production"
echo "  ./scripts/deploy-ip.sh"
echo "  open http://159.75.87.182"
